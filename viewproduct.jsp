...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index">Admin Home</a>
    </div>
  ...
  <li><a href="${pageContext.request.contextPath}/index"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
    </ul>
  </div>
</nav>
<h2>Product Details</h2>
      <div class="container">
		...
		<p>©Wolksvagen Online Cars-All Rights Reserved</p>
		<P>2016</P>
	</footer>
